...
ShaderProgram::ShaderProgram(std::string _vertexShader, std::string _geometryShader, std::string _fragmentShader)
{
	vertexShader = LoadVertexShader(_vertexShader);
	geometryShader = LoadGeometryShader(_geometryShader);
	fragmentShader = LoadFragmentShader(_fragmentShader);
}
